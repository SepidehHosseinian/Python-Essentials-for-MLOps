...
from ...operations._share_operations import build_acquire_lease_request, build_break_lease_request, build_change_lease_request, build_create_permission_request, build_create_request, build_create_snapshot_request, build_delete_request, build_get_access_policy_request, build_get_permission_request, build_get_properties_request, build_get_statistics_request, build_release_lease_request, build_renew_lease_request, build_restore_request, build_set_access_policy_request, build_set_metadata_request, build_set_properties_request
T = TypeVar('T')
